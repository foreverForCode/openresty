                    ...
                    if (result.data.memberRec.memberType == 2) {//代理商
                        ...
                        if (tmn == 1) {
                            if (result.data.returnUrl == null || result.data.returnUrl == '' || result.data.returnUrl == 'null') {
                                jems.goUrl("ucenter/members.html?tmn=" + result.data.memberRec.memberTmnId);
                            } else {
                                ...
                                window.location.href = changeURLArg(result.data.returnUrl, "tmn", result.data.memberRec.memberTmnId);
                            }
                        } else {
                            if (result.data.returnUrl == null || result.data.returnUrl == '' || result.data.returnUrl == 'null') {
                                jems.goUrl("ucenter/members.html");
