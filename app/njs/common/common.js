//本地存储
!function(a){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=a();else if("function"==typeof define&&define.amd)define([],a);else{var b;b="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,b.jeStore=a()}}(function(){function h(a){return"object"==typeof a&&"[object object]"===Object.prototype.toString.call(a).toLowerCase()&&!a.length}function i(a){return void 0===a||"function"==typeof a?a+"":JSON.stringify(a)}function j(a){if("string"!=typeof a)return void 0;try{return JSON.parse(a)}catch(b){return a||void 0}}function k(a){return"[object Function]"==={}.toString.call(a)}function l(a){return a instanceof Array}function m(a){var e,b="_Is_Incognit",c="yes";try{a.setItem(b,c)}catch(d){"QuotaExceededError"===d.name&&(e=function(){},a.__proto__={setItem:e,getItem:e,removeItem:e,clear:e})}finally{a.getItem(b)===c&&a.removeItem(b)}return a}function n(){return this instanceof n?void 0:new n}var e,d,g,o;if(window.localStorage){d=window.localStorage,g=function(){},d=m(d),n.prototype={set:function(a,b){if(g("set",a,b),a&&!h(a))d.setItem(a,i(b));else if(a&&h(a)&&!b)for(var c in a)this.set(c,a[c]);return this},get:function(a){if(!a){var b={};return this.forEach(function(a,c){b[a]=c}),b}return"?"===a.charAt(0)?this.has(a.substr(1)):j(d.getItem(a))},clear:function(){return this.forEach(function(a,b){g("clear",a,b)}),d.clear(),this},remove:function(a){var b=this.get(a);return d.removeItem(a),g("remove",a,b),b},has:function(a){return{}.hasOwnProperty.call(this.get(),a)},keys:function(){var a=[];return this.forEach(function(b){a.push(b)}),a},size:function(){return this.keys().length},forEach:function(a){var b,c;for(b=0;b<d.length&&(c=d.key(b),a(c,this.get(c))!==!1);b++);return this},search:function(a){var d,b=this.keys(),c={};for(d=0;d<b.length;d++)b[d].indexOf(a)>-1&&(c[b[d]]=this.get(b[d]));return c},onStorage:function(a){return a&&k(a)&&(g=a),this}},e=function(a,b){var g,c=arguments,d=n(),f=null;if(0===c.length)return d.get();if(1===c.length){if("string"==typeof a)return d.get(a);if(h(a))return d.set(a)}if(2===c.length&&"string"==typeof a){if(!b)return d.remove(a);if(b&&"string"==typeof b)return d.set(a,b);if(b&&k(b))return f=null,f=b(a,d.get(a)),f?e.set(a,f):e}if(2===c.length&&l(a)&&k(b)){for(g=0;g<a.length;g++)f=b(a[g],d.get(a[g])),e.set(a[g],f);return e}};for(o in n.prototype)e[o]=n.prototype[o];return e}});
//常用公共JS工具
