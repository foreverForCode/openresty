	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = document.querySelectorAll(params.elem + " img"),
				zoomMask  = document.querySelector(".imgzoombox"),
				zoomImg   = document.querySelector(".imgzoombox .imgzoom_img img"),
				zoomClose = document.querySelector(".imgzoombox .imgzoom_close"),
				imgSrc    = "";
		...
		addEventStart: function(param){
			...
			self.element = document.querySelector(".imgzoombox img");
